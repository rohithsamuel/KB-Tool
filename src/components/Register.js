    ...
    return (
        ...
        <div className="loginform" >
            ...
            <form onSubmit={submitForm} autoComplete="off">
                ...
                <input type="text" name="name" onChange={onChangeInput} placeholder="Your name" id="name" value={formData.name} required /><br></br>
                ...
                <input type="password" name="password" onChange={onChangeInput} placeholder="New password" id="password" value={formData.password} required /><br></br>
